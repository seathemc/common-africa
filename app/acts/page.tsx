...
export default function ActsPage() {
  ...
  return (
    <section className="container-wide py-20">
      ...
      <h2 className="mt-20 text-sm uppercase tracking-widest text-muted-foreground">
      ...
      <div className="mt-20 border-t hairline pt-10">
        ...
        <ul className="mt-6 grid md:grid-cols-2 gap-x-12 gap-y-4 text-muted-foreground leading-relaxed">
        ...
        <tbody>
          {acts.map((a) => (
            <tr key={a.iso} className="border-b hairline last:border-b-0 hover:bg-black/[0.02]">
              ...
              <td className="px-4 py-3 text-muted-foreground">{a.region} · {a.rec}</td>
              <td className="px-4 py-3 text-muted-foreground">{a.year ?? "—"}</td>
              <td className="px-4 py-3 text-muted-foreground">{a.ageLimit ? `${a.ageLimit} yrs` : "—"}</td>
              <td className="px-4 py-3 text-muted-foreground">{a.labelingBody ?? "—"}</td>
              <td className="px-4 py-3 text-muted-foreground">{a.taxHoliday ?? "—"}</td>
